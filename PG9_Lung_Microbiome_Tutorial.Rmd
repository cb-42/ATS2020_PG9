---
title: "PG9: Lung Microbiome Tutorial"
...
Lastly, we add a legend to arrive at the final figure. Although other plot customizations could be made, this is where we'll stop for the purposes of this demonstration.  
...
First we'll compute the Shannon diversity with the `diversity()` function. Then we'll select the observations of interest and compute summary statistics.
